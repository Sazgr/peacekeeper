...
inline void print_info(std::ostream& out) {
    ...
    out << "id author Kyle Zhang" << '\n'
...
#ifdef SPSA
        << "option name futility_multiplier type spin default 800 min 0 max 1000" << '\n'
        << "option name futility_power type spin default 66 min 0 max 1000" << '\n'
        ...
        << "option name nmp_base type spin default 230 min 0 max 10000" << '\n'
        << "option name nmp_depth_divisor type spin default 410 min 0 max 10000" << '\n'
        << "option name nmp_eval_divisor type spin default 1280 min 0 max 10000" << '\n'
