...
inline void print_info(std::ostream& out) {
    ...
    out << "id author Kyle Zhang" << '\n'
        ...
        << "option name futility_depth_margin type spin default 810 min 0 max 10000" << '\n'
        ...
        << "option name see_noisy_constant type spin default 2906 min 0 max 10000" << '\n'
        << "option name see_noisy_linear type spin default 0 min 0 max 1000" << '\n'
        << "option name see_noisy_quadratic type spin default 2050 min 0 max 1000" << '\n'
        << "option name see_quiet_constant type spin default 2304 min 0 max 10000" << '\n'
        << "option name see_quiet_linear type spin default 256 min 0 max 1000" << '\n'
        << "option name see_quiet_quadratic type spin default 2250 min 0 max 1000" << '\n'
        << "option name singular_extension_margin type spin default 68 min 0 max 1000" << '\n'
        << "option name double_extension_margin type spin default 19 min 0 max 1000" << '\n'
        << "option name aspiration_beta_timescale type spin default 139 min 0 max 1000" << '\n'
        << "option name tc_stability_base type spin default 80 min 0 max 1000" << '\n'
        << "option name tc_stability_multiplier type spin default 146 min 0 max 1000" << '\n'
        << "option name tc_stability_power type spin default 329 min 0 max 1000" << '\n'
        << "option name probcut_margin type spin default 175 min 0 max 1000" << '\n'
        << "option name history_pruning_base type spin default 3003 min 0 max 10000" << '\n'
        << "option name history_pruning_depth_margin type spin default 471 min 0 max 10000" << '\n'
        << "option name history_pruning_pv_margin type spin default 514 min 0 max 10000" << '\n'
        << "option name history_pruning_improving_margin type spin default 195 min 0 max 10000" << '\n'
        << "option name history_lmr_divisor type spin default 1138 min 0 max 10000" << '\n'
#endif
        << "uciok" << std::endl;
}
