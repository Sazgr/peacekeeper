...
inline void print_info(std::ostream& out) {
    ...
    out << "id author Kyle Zhang" << '\n'
...
#ifdef SPSA
        << "option name futility_base type spin default 340 min 0 max 1000" << '\n'
        << "option name futility_depth_margin type spin default 850 min 0 max 10000" << '\n'
        << "option name aspiration_base type spin default 280 min 0 max 1000" << '\n'
        << "option name lmr_base type spin default 94 min 0 max 10000" << '\n'
        ...
        << "option name nmp_base type spin default 217 min 0 max 10000" << '\n'
        << "option name nmp_depth_divisor type spin default 422 min 0 max 10000" << '\n'
        << "option name nmp_eval_divisor type spin default 1170 min 0 max 10000" << '\n'
        ...
        << "option name see_noisy_quadratic type spin default 2100 min 0 max 10000" << '\n'
        ...
        << "option name see_quiet_quadratic type spin default 2300 min 0 max 10000" << '\n'
        << "option name singular_extension_margin type spin default 65 min 0 max 1000" << '\n'
        << "option name double_extension_margin type spin default 15 min 0 max 1000" << '\n'
        << "option name aspiration_beta_timescale type spin default 131 min 0 max 1000" << '\n'
        << "option name tc_stability_base type spin default 83 min 0 max 1000" << '\n'
        << "option name tc_stability_multiplier type spin default 135 min 0 max 1000" << '\n'
        << "option name tc_stability_power type spin default 334 min 0 max 1000" << '\n'
        << "option name probcut_margin type spin default 220 min 0 max 1000" << '\n'
        << "option name history_pruning_base type spin default 3012 min 0 max 10000" << '\n'
        << "option name history_pruning_depth_margin type spin default 579 min 0 max 10000" << '\n'
        << "option name history_pruning_pv_margin type spin default 535 min 0 max 10000" << '\n'
        << "option name history_pruning_improving_margin type spin default 231 min 0 max 10000" << '\n'
        << "option name history_lmr_divisor type spin default 1049 min 0 max 10000" << '\n'
#endif
        << "uciok" << std::endl;
}
