...
inline void print_info(std::ostream& out) {
    ...
    out << "id author Kyle Zhang" << '\n'
        ...
        << "option name aspiration_bounds_0 type spin default 24 min 0 max 1000" << '\n'
        << "option name aspiration_bounds_1 type spin default 96 min 0 max 1000" << '\n'
        << "option name aspiration_bounds_2 type spin default 250 min 0 max 1000" << '\n'
