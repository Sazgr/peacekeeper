...
inline void print_info(std::ostream& out) {
    out << "id name Peacekeeper v" << std::fixed << std::setprecision(2) << VERSION << std::defaultfloat << std::setprecision(6) << '\n'
        ...
        << "option name see_losing type spin default 110 min 0 max 10000" << '\n'
        << "option name see_noisy_multiplier type spin default 800 min 0 max 10000" << '\n'
        << "option name see_noisy_power type spin default 200 min 0 max 1000" << '\n'
        << "option name see_noisy_multiplier type spin default 1000 min 0 max 10000" << '\n'
        << "option name see_noisy_power type spin default 220 min 0 max 1000" << '\n'
