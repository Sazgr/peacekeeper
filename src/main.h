...
spsa double futility_depth_margin = 81;
spsa double aspiration_base = 26;
spsa double aspiration_power = 3.16;
spsa double lmr_base = 0.54;
spsa double lmr_nopv_divisor = 1.97;
spsa double lmr_ispv_divisor = 3.94;
spsa double nmp_base = 2.19999999;
spsa double nmp_depth_divisor = 3.93;
...
spsa int singular_extension_margin = 68;
spsa int double_extension_margin = 19;
spsa double aspiration_beta_timescale = 1.39;
spsa double tc_stability_base = 0.80;
spsa double tc_stability_multiplier = 1.46;
spsa double tc_stability_power = 0.329;
spsa int probcut_margin = 175;
spsa int history_pruning_base = 3003;
spsa int history_pruning_depth_margin = 471;
spsa int history_pruning_pv_margin = 514;
spsa int history_pruning_improving_margin = 195;
spsa int history_lmr_divisor = 1138;
