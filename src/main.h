...
spsa double aspiration_base = 31;
spsa double aspiration_power = 3.36;
spsa double lmr_base = 0.66;
spsa double lmr_nopv_divisor = 2.0;
spsa double lmr_ispv_divisor = 3.8;
spsa double nmp_base = 2.19999999;
spsa double nmp_depth_divisor = 4.05;
spsa double nmp_eval_divisor = 11.8;
spsa double see_noisy_constant = 307.5;
spsa double see_noisy_linear = 0.0;
spsa double see_noisy_quadratic = 20.9;
spsa double see_quiet_constant = 214.0;
spsa double see_quiet_linear = 23.5;
spsa double see_quiet_quadratic = 22.4;
spsa int singular_extension_margin = 66;
spsa int double_extension_margin = 22;
spsa double aspiration_beta_timescale = 1.34;
spsa double tc_stability_base = 0.81;
spsa double tc_stability_multiplier = 1.25;
spsa double tc_stability_power = 0.306;
spsa int razoring_base = -65;
spsa int razoring_depth_multiplier = 184;
spsa int lmr_history_base = 3035;
