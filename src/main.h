...
spsa double see_losing = -117;
spsa double see_noisy_multiplier = 8.4;
spsa double see_noisy_power = 2.3;
spsa double see_quiet_multiplier = 11.1;
spsa double see_quiet_power = 2.0;
