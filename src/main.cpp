    ...
    while (true) {
        ...
        if (tokens[0] == "go") {
            ...
            if (movetime == 0 && calculate == true) {
                ...
                int movestogo_est = (position.ply < 40 ? 20 + (40 - position.ply) * (40 - position.ply) / 64 : 20);
                if (movestogo == 0 || movestogo > movestogo_est) {movestogo = movestogo_est;} //estimated number of moves until fresh time or end of game
